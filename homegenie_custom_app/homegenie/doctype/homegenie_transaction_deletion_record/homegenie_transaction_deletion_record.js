...
frappe.ui.form.on("Homegenie Transaction Deletion Record", {
	onload: function (frm) {
		if (frm.doc.docstatus == 0) {
			let doctypes_to_be_ignored_array;
			frappe.call({
				method: "homegenie_custom_app.homegenie.doctype.homegenie_transaction_deletion_record.homegenie_transaction_deletion_record.get_doctypes_to_be_ignored",
				callback: function (r) {
